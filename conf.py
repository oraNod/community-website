...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
        ("/pages/how-to-make-money.html", "Yess"),
    ),
}
...
try:
    ...
    "links": load_data('data/links.yaml'),
    "pages": load_data('data/pages.yaml'),
    "projects": load_data('data/projects.yaml')
    }
